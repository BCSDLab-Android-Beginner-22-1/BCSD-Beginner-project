...
class MainActivity : AppCompatActivity() {
    ...
    private val viewModel: FutureWeatherViewModel by viewModels<FutureWeatherViewModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val stitem:StITEM = StITEM("자료구분","20220811","fcsttime","fcstvalue")

        val futureweatherentity : List<FutureWeatherEntity> = listOf(FutureWeatherEntity(stF,stitem))
...
//        val viewModel:FutureWeatherViewModel = ViewModelProvider(this).get(FutureWeatherViewModel::class.java)
        ...
        viewModel.deleteWeather("20220812")
        viewModel.insertFutureWeather(futureweatherentity)

        viewModel.getFutureWeather("20220811").observe(this, Observer{
            Log.v(TAG, ">>> $it")
        })

//
//        viewModel.getFutureWeather("20220812").observe(this, Observer {
//            Log.v(TAG, ">>> $it")
//        })
