...
object TodayForecastDiffUtil : DiffUtil.ItemCallback<UltraShortTermForecast>() {
    override fun areItemsTheSame(oldItem: UltraShortTermForecast, newItem: UltraShortTermForecast): Boolean {
        return oldItem.forecastTime == newItem.forecastTime
    }

    override fun areContentsTheSame(oldItem: UltraShortTermForecast, newItem: UltraShortTermForecast): Boolean {
